...
path_out=['D:\cbnovo\'];
ncfile = [path_in,'wrfout_d03_2016-01-23_16_40_00'];
ncdisp(ncfile);
...
true_uvel = uvel(1:60, :, 1, 1);

vvel = ncread(ncfile,'V');
true_vvel = vvel(:, 1:60, 1, 1);
...
i = 4;
m_proj('lambert','lat',[-21.6 -18],'lon',[-42 -38.1]);
...
title(['Vento a 10m sobre o estado do Espírito Santo              '; 'Output do modelo WRF (Resolução: 3km) - 23/01/2016 - 16:00'],'fontsize',14,'fontweight','bold');
